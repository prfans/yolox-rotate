...
from yolov5_models.common import *
from yolov5_models.experimental import *
from yolov5_models.general import make_divisible, check_file, set_logging
from yolov5_models.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, \
...
class Detect(nn.Module):
    def __init__(self, nc=80, anchors=(), ch=()):  # detection layer
        ...
        # self.m = nn.ModuleList(nn.Conv2d(x, in_channels, 1) for x in ch)  # output conv
        # print('ch: ', ch)
...
class Model(nn.Module):
    def __init__(self, cfg='yolov5s.yaml', ch=3, nc=None, anchors=None, in_channels=None):  # model, input channels, number of classes
