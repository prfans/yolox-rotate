...
class Exp(BaseExp):
    def __init__(self):
        ...
        #self.data_dir = r'Y:\data_mix_1&3' #r'D:\data\coco2017'
        # name of annotation file for training
        #self.train_ann = "train.json" #""instances_train2017.json"
        # name of annotation file for evaluation
        #self.val_ann = "test.json" #"#"instances_val2017.json"
        # name of annotation file for testing
        #self.test_ann = "val.json" #"instances_test2017.json"
