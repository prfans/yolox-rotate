...
class Exp(MyExp):
    def __init__(self):
        ...
        # model config file
        self.cfg_file = './yolov5_models/yolov5_repvgg.yaml'
        ...
        self.data_dir_train = r'/data/data_train'
        self.data_dir_test = r'/data/data_test'
        self.names_file = r'/data/class.names'
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHead(self.num_classes, self.width, in_channels=in_channels, angles=self.angles, act=self.act)
