...
def make_parser():
    ...
    parser.add_argument("-n", "--name", type=str, default='yolov5_repvgg', help="model name")
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default=None, #'./exps/default/yolox_s.py',
        type=str,
...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        ...
        if save_result:
            ...
            jpg_name = image_name.replace('.bmp', '.jpg')
            save_file_name = os.path.join(save_folder, os.path.basename(jpg_name))
...
if __name__ == "__main__":
    ...
    print('args.exp_file: ', args.exp_file)
    print('args.name: ', args.name)
    print('args.legacy: ', args.legacy)
